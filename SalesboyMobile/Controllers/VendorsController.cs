...
namespace SalesboyMobile.Controllers
{
    public class VendorsController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Register(string firstname, string lastname, string email, string phone, string password, string state, string address, string business) //string state, string agree, string businessname, string category, string description, string address
        {
            //SendMail
            try
            {
        ...
        public ActionResult ProfilePicture(HttpPostedFileBase file, string id, string name)
        {
            try
            {
                ...
                if (file.ContentLength > 0)
                {
                    ...
                    string folder = Server.MapPath("~/Content/Images/Vendors/profile");
                    ...
                    file.SaveAs(_path);
                    string pic = "/Content/Images/Vendors/profile/" + id + extension;
                    user.photo = pic;
                }
